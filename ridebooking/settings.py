...
# Custom authentication backend to repair invalid Decimal values on user load
AUTHENTICATION_BACKENDS = [
    'accounts.backends.CleaningModelBackend',
...
if USE_S3:
    ...
    # S3 Media settings (if you have media files)
